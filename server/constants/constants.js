...
export const DOMAIN = 'room.imexfinance.ru';
...
export const FINNHUB_API_KEY_PROD = 'cbq1582ad3i9b8tf8qg0';
...
export const DEV_MAIL_CREDENTIALS = {
    login: 'imexfinanceservice@gmail.com',
    password: 'zcjdxwjsfqlwccsj'
};
